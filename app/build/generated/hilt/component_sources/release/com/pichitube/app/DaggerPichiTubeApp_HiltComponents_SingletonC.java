...
public final class DaggerPichiTubeApp_HiltComponents_SingletonC {
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new SettingsViewModel(singletonCImpl.prefsRepositoryProvider.get(), singletonCImpl.historyDao(), singletonCImpl.updateManagerProvider.get());

          case 5: // com.pichitube.app.feature.shorts.ShortsViewModel 
          return (T) new ShortsViewModel(singletonCImpl.extractorServiceProvider.get(), singletonCImpl.prefsRepositoryProvider.get());

          case 6: // com.pichitube.app.feature.subscriptions.SubscriptionsViewModel 
  ...
  private static final class ServiceCImpl extends PichiTubeApp_HiltComponents.ServiceC {
    ...
    private PlayerService injectPlayerService2(PlayerService instance) {
      PlayerService_MembersInjector.injectPlayerManager(instance, singletonCImpl.playerManagerProvider.get());
      return instance;
    }
  }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 8: // com.pichitube.app.core.update.UpdateManager 
          return (T) new UpdateManager(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), singletonCImpl.provideOkHttpClientProvider.get());
