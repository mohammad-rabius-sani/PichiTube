...
public final class PrefsRepository_Factory implements Factory<PrefsRepository> {
  ...
  public PrefsRepository_Factory(Provider<Context> contextProvider) {
  ...
  public static PrefsRepository_Factory create(javax.inject.Provider<Context> contextProvider) {
    return new PrefsRepository_Factory(Providers.asDaggerProvider(contextProvider));
  }
